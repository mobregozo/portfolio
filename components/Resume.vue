        ...
        <div class="my-auto">
          ...
          >
            <div class="mr-auto">
              ...
              <div class="mb-3 font-bold text-gray-600">
                at MOBIQUITY - Amsterdam, The Netherlands
              </div>
          ...
          >
            <div class="mr-auto">
              ...
              <p class="mt-8 text-gray-600 font-semibold">
                ...
                media, which allows users to share and support private and
                emotional conversations. Since we were a small team, I was
                involved in all technical and non-technical discussions related
                to the end product, and also was able to refactor the
                Application to improve several aspects that were missing at the
                moment that we took over it.
              </p>
              <p class="mt-5 text-gray-600 font-semibold">
                <strong>Main Technologies:</strong>
          ...
          >
            <div class="mr-auto">
              ...
              <div class="mb-3 font-bold text-gray-600">
                at Grupo Assa - Tandil, Argentina
              </div>
              <p class="mt-8 text-gray-600 font-semibold">
